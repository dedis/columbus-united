...
export class DetailBlock {
  ...
  blockInfoContainer:d3.Selection<HTMLDivElement, unknown, HTMLElement, any>;
  constructor(
  ...
  private listTransaction(block: SkipBlock) {
    let transactionContainer = d3.select(".blocksDetailcontainer");
